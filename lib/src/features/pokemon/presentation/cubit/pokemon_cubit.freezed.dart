...
abstract class $PokemonStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Pokemon>? pokemons, LoadState state, String? errorMessage});
}
...
class _$PokemonStateImpl extends _PokemonState {
  ...
  @override
  String toString() {
    return 'PokemonState(pokemons: $pokemons, state: $state, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_pokemons), state, errorMessage);
...
abstract class _PokemonState extends PokemonState {
  const factory _PokemonState(
      {final List<Pokemon>? pokemons,
      final LoadState state,
      final String? errorMessage}) = _$PokemonStateImpl;
